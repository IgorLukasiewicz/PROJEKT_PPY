...
Klasa ``Kameleon`` dziedziczy po klasie ``Pet`` i reprezentuje konkretne zwierzę – kameleona.
...
- ``textureBeforeEvolve``: `"Assets/Images/PetsTxt/BeforeEvolution/kameleon.png"`
- ``textureAfterEvolve``: `""`
