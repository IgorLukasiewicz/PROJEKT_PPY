...
Klasa ``Wieloryb`` dziedziczy po klasie ``Pet`` i reprezentuje konkretne zwierzę – wieloryba.
...
- ``textureBeforeEvolve``: `"Assets/Images/PetsTxt/BeforeEvolution/wieloryb.png"`
- ``textureAfterEvolve``: `""`
- ``backgroundTexture``: `"Assets/Images/Backgrounds/AnimalBackgrounds/Ocean.png"`
